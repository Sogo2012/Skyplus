...
STRINGS = {
    ...
    # ── PDF — completo bilingüe ──────────────────────────────────────────
    "pdf_kpi_max_savings":   {"ES": "Ahorro energético\nmáximo",          "EN": "Maximum\nEnergy Savings"},
    "pdf_kpi_kwh_year":      {"ES": "kWh ahorrados\npor año",             "EN": "kWh saved\nper year"},
    "pdf_kpi_sfr_rec":       {"ES": "SFR recomendado\n(Óptimo Dual)",     "EN": "Recommended SFR\n(Dual Optimum)"},
    "pdf_kpi_lux":           {"ES": "Iluminancia\npromedio (lux)",        "EN": "Average\nIlluminance (lux)"},
    "pdf_kpi_sfr_opt":       {"ES": "SFR Óptimo\nEnergético",             "EN": "Energy\nOptimum SFR"},
    "pdf_kpi_max_pct":       {"ES": "Ahorro\nmáximo",                     "EN": "Maximum\nSavings"},
    "pdf_kpi_kwh_saved":     {"ES": "kWh/año\nahorrados",                 "EN": "kWh/yr\nsaved"},
    "pdf_kpi_kwh_base":      {"ES": "kWh/año\nconsumo base",              "EN": "kWh/yr\nbaseline"},
    "pdf_client_header":     {"ES": "CLIENTE",                             "EN": "CLIENT"},
    "pdf_project_header":    {"ES": "PROYECTO",                            "EN": "PROJECT"},
    "pdf_field_name":        {"ES": "Nombre",                              "EN": "Name"},
    "pdf_field_company":     {"ES": "Empresa",                             "EN": "Company"},
    "pdf_field_email":       {"ES": "Correo",                              "EN": "Email"},
    "pdf_field_date":        {"ES": "Fecha",                               "EN": "Date"},
    "pdf_field_building":    {"ES": "Nave",                                "EN": "Building"},
    "pdf_field_usage":       {"ES": "Uso",                                 "EN": "Usage"},
    "pdf_field_climate":     {"ES": "Clima",                               "EN": "Climate"},
    "pdf_field_engine":      {"ES": "Motor",                               "EN": "Engine"},
    "pdf_dome_spec":         {"ES": "Domo Sunoptics® Especificado",        "EN": "Sunoptics® Dome Specified"},
    "pdf_dome_label":        {"ES": "Modelo",                              "EN": "Model"},
    "pdf_sfr_design":        {"ES": "SFR diseño",                          "EN": "Design SFR"},
    "pdf_dome_units":        {"ES": "domos",                               "EN": "domes"},
    "pdf_client_notes":      {"ES": "Notas del Cliente",                   "EN": "Client Notes"},
    "pdf_geo_desc":          {"ES": "Distribución matricial de",           "EN": "Grid distribution of"},
    "pdf_geo_over":          {"ES": "sobre una nave de",                   "EN": "over a facility of"},
    "pdf_geo_sfr_real":      {"ES": "SFR real",                            "EN": "Actual SFR"},
    "pdf_table_sfr":         {"ES": "SFR",                                 "EN": "SFR"},
    "pdf_table_domes":       {"ES": "Domos",                               "EN": "Domes"},
    "pdf_table_ah_luz":      {"ES": "Ah. Luz (kWh)",                       "EN": "Light Sav. (kWh)"},
    "pdf_table_pen_cool":    {"ES": "Pen. Cool (kWh)",                     "EN": "Cool Pen. (kWh)"},
    "pdf_table_neto":        {"ES": "Neto (kWh)",                          "EN": "Net (kWh)"},
    "pdf_table_pct":         {"ES": "% Base",                              "EN": "% Base"},
    "pdf_table_lux":         {"ES": "Lux prom.",                           "EN": "Avg. Lux"},
    "pdf_table_sem":         {"ES": "Semáforo",                            "EN": "Compliance"},
    "pdf_energy_desc":       {"ES": "Se corrieron",                        "EN": "We ran"},
    "pdf_energy_sims":       {"ES": "7 simulaciones EnergyPlus 23.2",      "EN": "7 EnergyPlus 23.2 simulations"},
    "pdf_heatmap_desc":      {"ES": "Mapa horario de iluminancia interior promedio para", "EN": "Average interior illuminance hourly map for"},
    "pdf_heatmap_desc2":     {"ES": "Las zonas rojas indican períodos donde la luz natural supera el setpoint normativo, eliminando totalmente la necesidad de iluminación artificial.", "EN": "Red zones indicate periods where daylight exceeds the normative setpoint, completely eliminating the need for artificial lighting."},
    "pdf_normative_status":  {"ES": "Estado normativo",                    "EN": "Regulatory Status"},
    "pdf_bem_desc":          {"ES": "Simulación espacial con Radiance. Validación punto por punto, certificación LEED v4.1, EDGE y BREEAM. Mapas de iluminancia y deslumbramiento.", "EN": "Spatial simulation with Radiance. Point-by-point validation, LEED v4.1, EDGE and BREEAM certification. Illuminance and glare maps."},
    "pdf_exec_desc":         {"ES": "Layout optimizado de domos. Especificaciones técnicas completas. Análisis de ROI y período de retorno. Presupuesto de instalación Sunoptics®.", "EN": "Optimized dome layout. Complete technical specifications. ROI analysis and payback period. Sunoptics® installation budget."},
    "pdf_disclaimer":        {"ES": "Para mayor información contáctenos en <b>ingenieria@ecoconsultor.com</b> · Los resultados de este reporte fueron generados con EnergyPlus 23.2 (DOE). Para certificaciones LEED, EDGE o validación espacial detallada, se requiere un estudio BEM completo con simulación Radiance.", "EN": "For more information contact us at <b>ingenieria@ecoconsultor.com</b> · The results in this report were generated with EnergyPlus 23.2 (DOE). For LEED, EDGE or detailed spatial validation certifications, a full BEM study with Radiance simulation is required."},
    "pdf_ficha_param":       {"ES": "Parámetro",                           "EN": "Parameter"},
    "pdf_ficha_value":       {"ES": "Valor",                               "EN": "Value"},
    "pdf_ficha_desc":        {"ES": "Descripción",                         "EN": "Description"},
    "pdf_ficha_domes_row":   {"ES": "Domos",                               "EN": "Domes"},
    "pdf_ficha_norm":        {"ES": "Normativa",                           "EN": "Standard"},
    "pdf_ficha_norm_val":    {"ES": "ISO 8995-1",                          "EN": "ISO 8995-1"},
    "pdf_ficha_norm_desc":   {"ES": "Setpoint iluminación según tipo de uso", "EN": "Illuminance setpoint by occupancy type"},
    "pdf_ficha_sfr_desc":    {"ES": "Área domos / Área techo",             "EN": "Dome area / Roof area"},
    "pdf_ficha_domes_desc":  {"ES": "Unidades instaladas en cuadrícula simétrica", "EN": "Units installed in symmetric grid"},
    "pdf_ficha_model_desc":  {"ES": "Referencia Sunoptics®",               "EN": "Sunoptics® Reference"},
    "pdf_months":            {"ES": "Ene,Feb,Mar,Abr,May,Jun,Jul,Ago,Sep,Oct,Nov,Dic", "EN": "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec"},
    "pdf_heatmap_title":     {"ES": "Disponibilidad de Luz Natural",       "EN": "Daylight Availability"},
    "pdf_heatmap_tod":       {"ES": "Hora del día",                        "EN": "Time of Day"},
    "pdf_heatmap_lux":       {"ES": "Lux promedio",                        "EN": "Average Lux"},
    # ── APP — textos faltantes ────────────────────────────────────────────
    "project_summary":       {"ES": "📋 Resumen del Proyecto",             "EN": "📋 Project Summary"},
    "kpi_savings":           {"ES": "Ahorro con tu diseño",                "EN": "Savings with your design"},
    "kpi_baseline":          {"ES": "Consumo base (sin domos)",            "EN": "Baseline (no domes)"},
    "kpi_domes_inst":        {"ES": "Domos instalados",                    "EN": "Domes installed"},
    "kpi_visual_comfort":    {"ES": "Confort visual",                      "EN": "Visual comfort"},
    "your_facility_results": {"ES": "📊 Tu Nave — Resultado Energético",   "EN": "📊 Your Facility — Energy Results"},
    "skyplus_dome_label":    {"ES": "Domo",                                "EN": "Dome"},
    "skyplus_facility_label":{"ES": "Nave",                                "EN": "Facility"},
    "dome_props_expander":   {"ES": "Ver propiedades del domo",            "EN": "View dome properties"},
    "dome_size_label":       {"ES": "Tamaño",                              "EN": "Size"},
    "tech_justify":          {"ES": "Justificación técnica para domos prismáticos de alta difusión.", "EN": "Technical justification for high-diffusion prismatic domes."},
    "compare_no_domes":      {"ES": "Compara tu nave sin domos vs con SFR", "EN": "Compare your facility without domes vs with SFR"},
    "prismatic_note":        {"ES": "💡 Los domos prismáticos Sunoptics difunden la luz hasta 3× más que una ventana plana.", "EN": "💡 Sunoptics prismatic domes diffuse light up to 3× more than a flat window."},
    "bem_premium_title":     {"ES": "🔬 Estudio BEM Premium",              "EN": "🔬 BEM Premium Study"},
    "bem_premium_desc":      {"ES": "Simulación espacial con Radiance. Validación punto por punto, certificaciones LEED.", "EN": "Spatial simulation with Radiance. Point-by-point validation, LEED certifications."},
    "exec_project_title":    {"ES": "📐 Proyecto Ejecutivo",               "EN": "📐 Executive Project"},
    "exec_project_desc":     {"ES": "Layout de domos, especificaciones técnicas, presupuesto y ROI.", "EN": "Dome layout, technical specifications, budget and ROI."},
    "contact_consultant":    {"ES": "Contacta a tu consultor Sunoptics.",   "EN": "Contact your Sunoptics consultant."},
    "designed_for":          {"ES": "Diseñado para licitaciones y proyectos de inversión.", "EN": "Designed for tenders and investment projects."},
    "geometry_section":      {"ES": "📐 2. Geometría de la Nave",           "EN": "📐 2. Facility Geometry"},
    "dome_section":          {"ES": "☀️ 4. Domo Sunoptics®",               "EN": "☀️ 4. Sunoptics® Dome"},
    "dome_model_select":     {"ES": "Modelo NFRC",                         "EN": "NFRC Model"},
    "send_report_btn":       {"ES": "📥 Generar y Enviar Reporte PDF",      "EN": "📥 Generate & Send PDF Report"},
    "report_sent_msg":       {"ES": "✅ ¡Reporte enviado a",               "EN": "✅ Report sent to"},
    "consultant_contact":    {"ES": "Un consultor de Eco Consultor se pondrá en contacto contigo.", "EN": "An Eco Consultor consultant will contact you."},
    "download_report":       {"ES": "### 📥 Descargar Reporte PDF",        "EN": "### 📥 Download PDF Report"},
    "send_to_label":         {"ES": "Se enviará a:",                       "EN": "Will be sent to:"},
    "units_ft2":             {"ES": "ft²",                                 "EN": "ft²"},
    "units_m2":              {"ES": "m²",                                  "EN": "m²"},
